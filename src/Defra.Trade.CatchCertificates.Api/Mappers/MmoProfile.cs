...
public class MmoProfile : Profile
{
    public MmoProfile()
    {
        ...
        CreateDataRowToModelMapping<CatchCertificateCaseDataRow, V3.Dtos.Mmo.CatchCertificateCase>(schemaRange: 1..3);
        ...
        CreateDataRowToModelMapping<ProcessingStatementDataRow, V3.Dtos.Mmo.ProcessingStatement>(schemaRange: 1..3);
        ...
        CreateDataRowToModelMapping<StorageDocumentDataRow, V3.Dtos.Mmo.StorageDocument>(schemaRange: 1..3);
