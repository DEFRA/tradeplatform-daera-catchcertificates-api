...
public class StorageDocumentController : ControllerBase
{
    ...
    /// <summary>
    /// Gets a V3 Storage Document by document number.
    /// </summary>
    ...
    [Audit(LogType = AuditLogType.DaeraFishExportServiceV3StorageDocumentGetById, WithResponseBody = true, SystemRequestIdRouteName = "documentNumber")]
