...
using DtosOutbound = Defra.Trade.CatchCertificates.Api.V3.Dtos.OutboundMmo;
...
public class CatchCertificateCaseController : ControllerBase
{
    ...
    /// <summary>
    /// Gets a V3 Catch Certificate Case by document number.
    /// </summary>
    ...
    [Audit(LogType = AuditLogType.DaeraFishExportServiceV3CatchCertificateCaseGetById, WithResponseBody = true, SystemRequestIdRouteName = "documentNumber")]
