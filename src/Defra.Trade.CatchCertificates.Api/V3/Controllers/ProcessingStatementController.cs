...
public class ProcessingStatementController : ControllerBase
{
    ...
    /// <summary>
    /// Gets a V3 Processing Statement by document number.
    /// </summary>
    ...
    [Audit(LogType = AuditLogType.DaeraFishExportServiceV3ProcessingStatementGetById, WithResponseBody = true, SystemRequestIdRouteName = "documentNumber")]
