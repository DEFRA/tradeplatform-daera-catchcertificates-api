...
namespace Defra.Trade.CatchCertificates.Api.IntegrationTests.V3.Controllers.MmoCatchCertificateCaseControllerTests;
...
public class UpsertTests : IClassFixture<CatchCertificatesApiWebApplicationFactory<Startup>>
{
    ...
    public async Task Upsert_UnknownApplication_CreatesNew()
    {
        ...
        var (_, dtoToSave) = CreateCatchCertificateCaseV3DataRow(_fixture, Version, "GBR-2023-CC-123UVWXYZ");
    ...
    public async Task Upsert_KnownApplication_UpdatesExisting()
    {
        ...
        var (existingDataRow, existingDto) = CreateCatchCertificateCaseV3DataRow(_fixture, Version, "GBR-2023-CC-223UVWXYZ", null, dr => dr.LastUpdated = DateTimeOffset.UtcNow.AddMinutes(-1));
    ...
    public async Task Upsert_KnownApplicationButOldMessage_DoesNotUpdate()
    {
        ...
        var (existingDataRow, existingDto) = CreateCatchCertificateCaseV3DataRow(_fixture, Version, "GBR-2021-CC-000ABCDEF", null, dr => dr.LastUpdated = DateTimeOffset.UtcNow.AddMinutes(-1));
    ...
    public async Task Upsert_InvalidPayload_BadRequest()
    {
        ...
        var (_, dtoToSave) = CreateCatchCertificateCaseV3DataRow(_fixture, invalidVersion, null, d => { d.LastUpdatedSystem = "12345678901"; d.LastUpdatedBy = new string('a', 101); });
