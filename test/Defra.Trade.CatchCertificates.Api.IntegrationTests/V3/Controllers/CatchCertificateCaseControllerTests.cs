...
using DtosInboundMmo = Defra.Trade.CatchCertificates.Api.V3.Dtos.Mmo;
using DtosOutboundMmo = Defra.Trade.CatchCertificates.Api.V3.Dtos.OutboundMmo;

namespace Defra.Trade.CatchCertificates.Api.IntegrationTests.V3.Controllers;
...
public class CatchCertificateCaseControllerTests : IClassFixture<CatchCertificatesApiWebApplicationFactory<Startup>>
{
    ...
    public CatchCertificateCaseControllerTests(CatchCertificatesApiWebApplicationFactory<Startup> webApplicationFactory)
    {
        ...
        _webApplicationFactory.ApiVersion = "3";

        _fixture = new Fixture();

        (_existingDataRow, _existingDto) = CreateCatchCertificateCaseV3DataRow(_fixture, 3, IdExistingItem);
    ...
    public async Task GetById_InvalidId_NotFound()
    {
        ...
        _webApplicationFactory.AuditRepository.VerifyAuditLogged(AuditingModels.Enums.AuditLogType.DaeraFishExportServiceV3CatchCertificateCaseGetById,
